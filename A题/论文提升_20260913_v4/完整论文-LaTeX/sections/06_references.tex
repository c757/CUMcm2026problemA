...
使用工具为OpenAI Codex，工具版本记录、关键提示、采纳范围与核验说明见支撑材料《AI工具使用详情》。本次中文编辑整理摘要、论证、结果分析和图注，保留模型假设、公式、数据、图表编号、引用及数值结论。计算数值来自所附程序。

参赛队仍须依据真实使用记录核对披露，独立理解和审阅方程、程序与结果，并对提交内容负责。最终人工审阅尚待完成。
